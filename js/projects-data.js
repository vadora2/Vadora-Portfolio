...
window.PROJECTS = [
...

  {
    ...
    cardDescription: "An AI-assisted sustainable swimwear platform that understands microfibre shedding and choose lower-impact materials.",
...

  {
    ...
    duration: "2-week project (School Project)",
...

  {
    ...
    cardDescription: "Marketing support through consultation and content organisation.",
...

  {
    ...
    cardDescription: "Graphic design and production support for branded events, including House of Sephora, Audemars Piguet, and Penfolds.",
